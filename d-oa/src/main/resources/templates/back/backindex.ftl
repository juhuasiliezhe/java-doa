...
<head>
    ...
    <link rel="stylesheet" href="${base}/static/css/skins/_all-skins.css">
</head>
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
    <div id="ajax-loader" style="cursor: progress; position: fixed; top: -50%; left: -50%; width: 200%; height: 200%; background: #fff; z-index: 10000; overflow: hidden;">
        <img src="${base}/static/img/ajax-loader.gif" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: auto;" />
    </div>
    <div class="wrapper">
        <!--头部信息-->
        <header class="main-header">
            <a href="http://www.learun.cn/adms/index.html" target="_blank" class="logo">
                <span class="logo-mini">51fl</span>
                <span class="logo-lg"><strong>风铃</strong></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li class="divider"></li>
                                <li><a href="/duserController/loginout.html"><i class="ace-icon fa fa-power-off"></i>安全退出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
        ...
        <div id="content-wrapper" class="content-wrapper">
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                    <iframe class="LRADMS_iframe" width="100%" height="100%" src="${base}/dappointmentController/showDAppointment.html" frameborder="0" data-id="${base}/index/blogindex"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="${base}/static/back/index.js"></script>
</body>
</html>
